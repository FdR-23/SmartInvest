...
const Cripto = () => {
  return (
    <div id="cripto" className="flex flex-col [&>section]:py-4 ">
      ...
      <section className="px-2">
        <h2 className="text-2xl font-bold p-2 whitespace-nowrap border-b border-black">
        ...
        <div className="mb-[50px] w-full h-full relative box-border">
          <div className="min-h-[500px]  px-2 pt-[16px] flex flex-col sm:flex-row sm:space-x-2">
            ...
            <div className="sm:w-[200px] h-full flex-1 py-2">
              <TendenceCripto />
            </div>
          </div>
        </div>
