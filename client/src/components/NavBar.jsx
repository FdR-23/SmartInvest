...
const NavBar = () => {
  ...
  return (
    <div className='bg-gray-300 h-[110px] flex flex-row relative  justify-between rounded-br-md rounded-bl-md text-[#0c1827] '>

      <div className='m-4 mt-2  -skew-x-3' >
        <div className='p-2 text-center border-2 border-black rounded-lg bg-black/20 shadow-sm shadow-black'>
          <Link to={"/"}>
